#!/usr/bin/env python3
"""
SVcustos — Entrenamiento de ConvNeXt-Tiny para clasificación de polígonos polares
==========================================================================
Entrena ConvNeXt-Tiny (transfer learning desde ImageNet) para clasificar
vectores ternarios representados como polígonos polares.

Uso:
  python train_convnext.py --level n16
  python train_convnext.py --level n16 --model resnet50 --epochs 30
...
def create_model(model_name, num_classes, pretrained=True):
    """Create a ConvNeXt model with transfer learning."""
...
def main():
    parser = argparse.ArgumentParser(
        description="SVcustos — Train ConvNeXt-Tiny on polar polygon images"
    )
    parser.add_argument("--level", required=True, choices=["n16", "n25", "n36"])
    parser.add_argument("--model", default=None, help="Model override (convnext_tiny/convnext_small)")
    ...
    print(f"═══ SVcustos ConvNeXt Training ═══")
    print(f"  Level: n={n}")
